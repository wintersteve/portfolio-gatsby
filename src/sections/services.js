      ...
      <div className="lg:pr-12">
        <div className="mb-10 lg:mb-0">
          ...
          <p>
            ...
            rhoncus pellentesque eros in maximus. Sed sem purus, condimentum id
            elementum vel, sagittis et lorem. In vestibulum rutrum metus, in
            tincidunt velit sollicitudin nec. Sed consectetur ullamcorper nisl
            id fringilla. Vivamus erat magna, pellentesque ut ornare eu,
            ...
            justo at laoreet tempor, lectus nisl finibus massa, viverra sagittis
            mi sapien et neque. Praesent sed mattis nunc, at aliquam orci.
            Quisque sit amet elit tempor, efficitur metus non, pretium nunc.
            Nulla facilisi.
          </p>
        </div>
      </div>
      <div>
        <div className="md:grid md:grid-cols-2 gap-6 lg:mb-6">
          <Tile
