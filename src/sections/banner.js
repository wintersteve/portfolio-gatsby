...
function Banner() {
  return (
    <section className="bg-gradient-to-b from-white to-gray-100 flex flex-col items-center justify-center pt-8 pb-20 md:py-28 lg:pt-36 lg:pb-48 2xl:mx-6 relative">
      <div>
        <ScrollAnimation
          animateIn="fade"
