...
function Footer() {
  return (
    <footer className="relative">
      <svg
        className="absolute bg-gray-100 dark:bg-primary-300 left-0 -top-20 sm:-top-32 md:-top-40 lg:-top-56 xl:-top-64 2xl:-top-80"
      ...
      <div className="bg-primary-200 relative text-white text-center px-20 lg:px-40 py-20 lg:pb-28 lg:pt-0">
